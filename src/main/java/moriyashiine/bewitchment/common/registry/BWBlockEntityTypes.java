...
public class BWBlockEntityTypes {
	...
	public static final BlockEntityType<TaglockHolderBlockEntity> TAGLOCK_HOLDER = create("taglock_holder", BlockEntityType.Builder.create(TaglockHolderBlockEntity::new, BWObjects.JUNIPER_FENCE_GATE, BWObjects.JUNIPER_PRESSURE_PLATE, BWObjects.JUNIPER_BUTTON, BWObjects.JUNIPER_TRAPDOOR, BWObjects.JUNIPER_DOOR).build(null));
	public static final BlockEntityType<LockableBlockEntity> LOCKABLE = create("lockable", BlockEntityType.Builder.create(LockableBlockEntity::new, BWObjects.ELDER_FENCE_GATE, BWObjects.ELDER_PRESSURE_PLATE, BWObjects.ELDER_BUTTON, BWObjects.ELDER_TRAPDOOR, BWObjects.ELDER_DOOR).build(null));
	...
	public static final BlockEntityType<ElderChestBlockEntity> ELDER_CHEST = create("elder_chest", BlockEntityType.Builder.create(ElderChestBlockEntity::new, BWObjects.ELDER_CHEST, BWObjects.TRAPPED_ELDER_CHEST).build(null));
	...
	private static <T extends BlockEntity> BlockEntityType<T> create(String name, BlockEntityType<T> type) {
		BLOCK_ENTITY_TYPES.put(type, Bewitchment.id(name));
		return type;
	}
